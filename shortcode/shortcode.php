...
<h2>主题短代码&copy; Jeff的阳台http://www.jianhui.org</h2>
...
<legend class="toggle">各种短代码面板</legend>
	<div class="none">
      <table width="600" border="0" class="devetable">
        ...
        <tr><td width="120">绿色清新面板：</td><td width="464"><code>[buy]文字内容[/buy]</code></td></tr>
       </table>
      </div>
</fieldset>
<fieldset>
...
function hcms_shortcode_page(){
  add_theme_page("主题短代码提示","主题短代码提示",'edit_themes','hcms_shortcode_page','hcms_Shortpage'); 
}
